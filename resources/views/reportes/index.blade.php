  ...
  <div class="row">
    <div class="col-2">
      ...
      <div class="input-group mb-0">
        ...
        <select class="custom-select" id="selectMes" name="selectMes" style="width:73%;">
        </select>
      </div>
      <div class="input-group mb-0">
        <div class="input-group-prepend" style="width:27%;">
...
function cargarGraficoHora(anio,mes,dia){
  var url = '{{url("")}}'+'/grafico/'+anio+'/'+mes+'/02';
